    ...
    const rejectQuote = async () => {
      try {
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL}/email-actions/quotes/${id}/reject?token=${token}`,
          {
            method: "GET",
            headers: {
        ...
        <div className="appointment-action-content">
          {status === "success" ? (
            <>
              ...
              <h2 className="appointment-action-title">Devis refusé</h2>
              ...
              {quote && (
                <div className="appointment-details">
                  ...
                  {quote.rejectionReason && (
                    <div className="detail-item">
                      <strong>Raison du refus :</strong> {quote.rejectionReason}
                    </div>
                  )}
                  <div className="detail-item">
